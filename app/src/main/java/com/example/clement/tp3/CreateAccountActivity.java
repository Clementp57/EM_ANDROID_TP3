...
public class CreateAccountActivity extends ActionBarActivity {
    ...
    private static final String url = "http://questioncode.fr:10007/api/users";
    ...
    public void checkAndSubmit(View v) {
        final Context context = this;

        EditText nameView = (EditText)findViewById(R.id.nameInput);
        EditText emailView = (EditText)findViewById(R.id.emailInput);
